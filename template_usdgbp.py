...
def ema():
    data_ema5, meta_data_ema = ti.get_ema(symbol='USDGBP', interval='1min', time_period=450)
    data_ema15, meta_data_ema = ti.get_ema(symbol='USDGBP', interval='1min', time_period=150)
